...
('sincan',	'admin',	'PRIMARY',	'2017-07-12 18:03:17',	'n_diff_pfx01',	0,	1,	'id_admin'),
('sincan',	'admin',	'PRIMARY',	'2017-07-12 18:03:17',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'admin',	'PRIMARY',	'2017-07-12 18:03:17',	'size',	1,	NULL,	'Number of pages in the index'),
('sincan',	'antrian',	'PRIMARY',	'2017-07-12 16:29:27',	'n_diff_pfx01',	0,	1,	'id_antrian'),
('sincan',	'antrian',	'PRIMARY',	'2017-07-12 16:29:27',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'antrian',	'PRIMARY',	'2017-07-12 16:29:27',	'size',	1,	NULL,	'Number of pages in the index'),
('sincan',	'kasir',	'PRIMARY',	'2017-07-12 18:03:02',	'n_diff_pfx01',	0,	1,	'id_kasir'),
('sincan',	'kasir',	'PRIMARY',	'2017-07-12 18:03:02',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'kasir',	'PRIMARY',	'2017-07-12 18:03:02',	'size',	1,	NULL,	'Number of pages in the index'),
('sincan',	'owner',	'PRIMARY',	'2017-07-12 18:02:49',	'n_diff_pfx01',	0,	1,	'id_owner'),
('sincan',	'owner',	'PRIMARY',	'2017-07-12 18:02:49',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'owner',	'PRIMARY',	'2017-07-12 18:02:49',	'size',	1,	NULL,	'Number of pages in the index'),
('sincan',	'pelanggan',	'PRIMARY',	'2017-07-12 19:32:30',	'n_diff_pfx01',	4,	1,	'id_pelangaan'),
('sincan',	'pelanggan',	'PRIMARY',	'2017-07-12 19:32:30',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'pelanggan',	'PRIMARY',	'2017-07-12 19:32:30',	'size',	1,	NULL,	'Number of pages in the index'),
('sincan',	'perawatan',	'PRIMARY',	'2017-07-12 17:47:07',	'n_diff_pfx01',	6,	1,	'id_perawatan'),
('sincan',	'perawatan',	'PRIMARY',	'2017-07-12 17:47:07',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'perawatan',	'PRIMARY',	'2017-07-12 17:47:07',	'size',	1,	NULL,	'Number of pages in the index'),
('sincan',	'produk',	'PRIMARY',	'2017-07-12 17:17:34',	'n_diff_pfx01',	4,	1,	'id_produk'),
('sincan',	'produk',	'PRIMARY',	'2017-07-12 17:17:34',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'produk',	'PRIMARY',	'2017-07-12 17:17:34',	'size',	1,	NULL,	'Number of pages in the index'),
('sincan',	'transaksi_pembelian',	'PRIMARY',	'2017-07-13 08:08:16',	'n_diff_pfx01',	2,	1,	'id_transaksi_pembelian'),
('sincan',	'transaksi_pembelian',	'PRIMARY',	'2017-07-13 08:08:16',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'transaksi_pembelian',	'PRIMARY',	'2017-07-13 08:08:16',	'size',	1,	NULL,	'Number of pages in the index'),
('sincan',	'transaksi_perawatan',	'PRIMARY',	'2017-07-13 08:09:58',	'n_diff_pfx01',	2,	1,	'id_transaksi_perawatan'),
('sincan',	'transaksi_perawatan',	'PRIMARY',	'2017-07-13 08:09:58',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sincan',	'transaksi_perawatan',	'PRIMARY',	'2017-07-13 08:09:58',	'size',	1,	NULL,	'Number of pages in the index'),
('sisfonews',	'berita',	'PRIMARY',	'2017-07-12 12:50:56',	'n_diff_pfx01',	6,	1,	'id_berita'),
('sisfonews',	'berita',	'PRIMARY',	'2017-07-12 12:50:56',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sisfonews',	'berita',	'PRIMARY',	'2017-07-12 12:50:56',	'size',	1,	NULL,	'Number of pages in the index'),
('sisfonews',	'berita',	'id_kategori',	'2017-07-12 12:50:56',	'n_diff_pfx01',	3,	1,	'id_kategori'),
('sisfonews',	'berita',	'id_kategori',	'2017-07-12 12:50:56',	'n_diff_pfx02',	6,	1,	'id_kategori,id_berita'),
('sisfonews',	'berita',	'id_kategori',	'2017-07-12 12:50:56',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sisfonews',	'berita',	'id_kategori',	'2017-07-12 12:50:56',	'size',	1,	NULL,	'Number of pages in the index'),
('sisfonews',	'kategori',	'GEN_CLUST_INDEX',	'2017-07-12 12:50:46',	'n_diff_pfx01',	3,	1,	'DB_ROW_ID'),
('sisfonews',	'kategori',	'GEN_CLUST_INDEX',	'2017-07-12 12:50:46',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('sisfonews',	'kategori',	'GEN_CLUST_INDEX',	'2017-07-12 12:50:46',	'size',	1,	NULL,	'Number of pages in the index');
...
('sincan',	'admin',	'2017-07-12 18:03:17',	0,	1,	0),
('sincan',	'antrian',	'2017-07-12 16:29:27',	0,	1,	0),
('sincan',	'kasir',	'2017-07-12 18:03:02',	0,	1,	0),
('sincan',	'owner',	'2017-07-12 18:02:49',	0,	1,	0),
('sincan',	'pelanggan',	'2017-07-12 19:32:30',	4,	1,	0),
('sincan',	'perawatan',	'2017-07-12 17:47:07',	6,	1,	0),
('sincan',	'produk',	'2017-07-12 17:17:34',	4,	1,	0),
('sincan',	'transaksi_pembelian',	'2017-07-13 08:08:16',	2,	1,	0),
('sincan',	'transaksi_perawatan',	'2017-07-13 08:09:58',	2,	1,	0),
('sisfonews',	'berita',	'2017-07-12 12:50:56',	6,	1,	1),
('sisfonews',	'kategori',	'2017-07-12 12:50:46',	3,	1,	0);
...
(1,	'mhargaret',	'085274738272'),
(2,	'udin',	'085326438574'),
(3,	'joko',	'085325635263'),
(4,	'samsul',	'085234538772'),
(5,	'inem',	'085132738372');
...
INSERT INTO `perawatan` (`id_perawatan`, `nama`, `harga`) VALUES
(1,	'Haircut',	20000),
(2,	'Creambath',	20000),
(3,	'Facial Wajah',	80000),
(4,	'Hair Styling',	50000),
(5,	'Sanggul',	65000);
...
(1,	'Makarizo Salon Dail',	90000),
(2,	'Makarizo Salon Daily',	70000),
(3,	'Lightning Face Mask',	20000),
(4,	'Makarizo Hair Energy',	20000),
(5,	'Makarizo Nutriv Seru',	60000);

DROP TABLE IF EXISTS `transaksi_pembelian`;
CREATE TABLE `transaksi_pembelian` (
  `id_transaksi_pembelian` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `transaksi_pembelian` (`id_transaksi_pembelian`, `nama_pelanggan`, `nama_produk`, `total`, `tgl`) VALUES
(1,	'mhargaret',	'Makarizo Salon Dail',	'90000',	'2017-07-13 15:07:43'),
(2,	'udin',	'Makarizo Salon Daily',	'70000',	'2017-07-13 15:08:16');

DROP TABLE IF EXISTS `transaksi_perawatan`;
CREATE TABLE `transaksi_perawatan` (
  `id_transaksi_perawatan` int(11) NOT NULL AUTO_INCREMENT,
  `nama_pelanggan` varchar(30) NOT NULL,
...
INSERT INTO `transaksi_perawatan` (`id_transaksi_perawatan`, `nama_pelanggan`, `nama_perawatan`, `total`, `tgl`) VALUES
(1,	'joko',	'Haircut',	'20000',	'2017-07-13 15:09:34'),
(2,	'samsul',	'Creambath',	'20000',	'2017-07-13 15:09:58');
...
CREATE TABLE `berita` (
  ...
  CONSTRAINT `berita_ibfk_1` FOREIGN KEY (`id_kategori`) REFERENCES `berita` (`id_berita`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `berita` (`id_berita`, `tanggal`, `judul`, `isi`, `id_kategori`) VALUES
(1,	'2017-05-09',	'GADGET1',	'update kembali ke kategori gadget',	1),
(2,	'2017-05-09',	'GADGET2',	'gadget2gadget2gadget2gadget2gadget2gadget2gadget2gadget2gadget2gadget2',	1),
(3,	'2017-05-09',	'GAMES1',	'games1games1games1games1games1games1games1games1games1games1',	2),
(4,	'2017-05-09',	'GAMES2',	'games2games2games2games2games2games2games2games2games2games2',	2),
(5,	'2017-05-09',	'CHEAT1',	'cheat1cheat1cheat1cheat1cheat1cheat1cheat1cheat1cheat1cheat1',	3),
(6,	'2017-05-09',	'CHEAT2',	'cheat2cheat2cheat2cheat2cheat2cheat2cheat2cheat2cheat2cheat2',	3);
